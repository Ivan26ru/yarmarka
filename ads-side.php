			...
			<main class="home">
				<div class="home__filter">
			 	...
			 	<div class="offer">
			 		<div class="offer__up">
			 			<h3 class="offer__name">
			 				Вакансии: <span>Виктор Юрьевич</span>
			 			</h3>
			 			<div class="offer__level">
			 				<p>Уровень Виктора: <span>0</span></p> 
			 		...
			 		<div class="offer__contant">
			 			<div class="offer__part">
				 			...
				 			<div class="offer__container">
				 				<div class="offer__status">
				 					<p>Статус:<span class="offer__other-status">Снято с публикации</span></p>
				 					<p><span>8/10</span></p>
				 				</div>
				 				<div class="offer__item">
					 				<span class="offer__like" id="like"> </span>
				 			...
				 			<div class="offer__container">
				 				<div class="offer__status">
				 					<p>Статус:<span class="offer__other-status">Продано</span></p>
				 					<p><span>8/10</span></p>
				 				</div>
				 				<div class="offer__item">
					 				<span class="offer__like" id="like"> </span>
			 	...
			 	<div class="offer">
			 		<div class="offer__up">
			 			<h3 class="offer__name">
			 				Объявления: <span>Виктор Юрьевич</span>
			 			</h3>
			 			<div class="offer__level">
			 				<p>Уровень Виктора:<span>0</span></p> 
			 				<a href="#" class="offer__reting">(смотреть рейтинг)</a>
			 	...
			 	<div class="offer">
			 		<div class="offer__up">
			 			<h3 class="offer__name">
			 				Аренда: <span>Виктор Юрьевич</span> 
			 			<div class="offer__level">
			 				<p>Уровень Виктора:<span>0</span></p> 
			 				<a href="#" class="offer__reting">(смотреть рейтинг)</a>
			 			</div>
			 	...
			 	<div class="offer">
			 		<div class="offer__up">
			 			<h3 class="offer__name">
			 				Услуги: <span> Виктор Юрьевич</span>
			 			</h3>
			 			<div class="offer__level">
			 				<p>Уровень Виктора:<span>0</span></p> 
			 				<a href="#" class="offer__reting">(смотреть рейтинг)</a>
