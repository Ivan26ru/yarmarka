            ...
            <div class="edit" id="edit">
                <div class="edit__up">
                    <div class="edit__part">
                        <h3 class="edit__name">
                            Услуги - Публикация объявления
                        </h3>
                        <p class="edit__text">
                            <span class="green">РО</span>
                            — рейтинг объявления. Объявления с более высоким рейтингом с большей вероятностью будут заметны, а доверие работодателей к таким объявлениям выше. YARMARKA помогает реализовать ваши объявления. Расскажите подробнее о навыках и опыте, опубликуйте фотографии и укажите место встречи.
                        </p>
                        <p class="edit__text">
                            <span class="blue">Подсказка:</span>
                            используйте ключевые слова в названии и описании объявления. Это слова, по которым работодатели ищут тот или иной товар. Например:<span class="italik"> “Без опыта”, “Студентам”, “Удаленно”, “Временно”, “Официант”</span> и другие.
                        </p>
                    </div>
                    <div class="edit__part">
                        <p>
                ...
                <ul class="edit__list">
                    ...
                    <li class="edit__item align-center">
                        ...
                        <div class="edit__cont">
                            <button class="edit__employment">Долгосрочная</button>
                            <button class="edit__employment">Посуточная</button>
                            <button class="edit__employment">Почасовая</button>
                            <button class="edit__employment">Бессрочная</button>
                        </div>
                        <div class="edit__status">
                            <span>+1 РО</span>
                        </div>
