...
<section class="contant" id="contant">
    <div class="container">
        ...
        <main class="home">
            ...
            <div class="like-user">
                <h3 class="like-user__title">
                    Мое избранное
                </h3>
                <h3 class="like-user__title">
                    Избранные пользователи
                </h3>
                <div class="like-user__cont">
                    <div class="like-user__item">
                        <span class="user-like__hard">
                            <img src="img/like.svg" alt=""/>
                        </span>
                        <div class="user-like__photo">
                            <img src="img/like-user.svg" alt=""/>
                        </div>
                        <p class="user-like__name">
                            Алексей
                        </p>
                        <span class="like-user__level">
                            (8lvl)
                        </span>
                    </div>
                    <div class="like-user__item">
