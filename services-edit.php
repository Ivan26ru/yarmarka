            ...
            <div class="edit" id="edit">
                ...
                <ul class="edit__list">
                    ...
                    <li class="edit__item align-center">
                        ...
                        <div class="edit__cont">
                            <button class="edit__employment">На дому</button>
                            <button class="edit__employment">С выездом</button>
                            <button class="edit__employment">В студии</button>
                            <button class="edit__employment">Удаленно</button>
                        </div>
                        <div class="edit__status">
                            <span>+1 РО</span>
                        </div>
